...
<div class="guide-page">
  <div class="guide-hero">
    <div class="container">
      ...
      <p class="guide-subtitle">The organizations worth knowing if you plan to keep running around here</p>
    </div>
  </div>
        ...
        <div class="intel-grid">
          ...
          <div class="intel-card">
            ...
            <div class="intel-card-body">
              ...
              <ul>
                ...
                <li><strong>Saturdays 8:30 AM</strong> — Zia Station</li>
                <li><strong>Sundays</strong> — Trail runs, announced weekly</li>
              </ul>
              <p class="intel-card-section-label">Store Hours</p>
              <ul>
                <li>Mon–Thu: 10am–6pm</li>
          ...
          <div class="intel-card">
            ...
            <div class="intel-card-body">
              ...
              <p class="intel-card-section-label">Group Runs</p>
              <ul>
                <li><strong>Tuesdays 5:45 PM</strong> — Santa Fe High School track (mid-March through October)</li>
                <li><strong>Thursdays 6 PM</strong> — From The Running Hub (3 & 6 miles, year-round)</li>
                <li><strong>Saturdays 8:30 AM</strong> — Zia Station</li>
                <li><strong>Sundays</strong> — Trail runs, announced weekly</li>
              </ul>
              <p class="intel-card-section-label">Annual Races</p>
              <ul>
                <li>Santa Fe Striders Running Festival (5K trail + kids run) — July</li>
                <li>Santa Fe International Half Marathon — September</li>
              </ul>
              <p class="intel-card-section-label">Membership</p>
              <ul>
